<?php
/**
 * Standalone install + heartbeat reporter for Panth_PriceDropAlert.
 *
...
namespace Panth\PriceDropAlert\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_PriceDropAlert';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-price-drop-alert';
